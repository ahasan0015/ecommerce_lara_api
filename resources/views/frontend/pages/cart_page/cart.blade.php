                        ...
                        @if(Auth::check())
                            @forelse($cartItems as $item)
                                <tr data-id="{{ $item->id }}">
                                    ...
                                    <td>
                                        <strong
                                            class="text-dark">{{ $item->variant->product->product_name ?? $item->variant->product->name }}</strong>
                                        <p class="small mb-0 text-muted mt-1">
                                            <span class="badge bg-light text-dark border">Size:
                                                {{ $item->size ?? optional($item->variant->size)->name }}</span><br>
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control text-center bg-white border-dark fw-bold"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">Your cart is currently empty!</td>
                                </tr>
                            @endforelse
                        @endif
                    </tbody>
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6 text-end">
                    <div class="bg-light p-4 rounded shadow-sm">
                        ...
                        <hr>
                        <a href="{{ route('checkout') }}" class="btn btn-dark w-100 py-2 fs-5 rounded-pill shadow">
