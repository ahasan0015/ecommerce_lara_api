...
<div class="main-wrapper overflow-hidden">
    ...
    <div class="container mt-4">
        <div id="topCarousel" class="carousel slide shadow-sm rounded-4 overflow-hidden" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('assets/images/products/1.webp') }}" class="d-block w-100" alt="Slide 1" style="height: 450px; object-fit: cover;">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('assets/images/products/2.webp') }}" class="d-block w-100" alt="Slide 2" style="height: 450px; object-fit: cover;">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('assets/images/products/3.webp') }}" class="d-block w-100" alt="Slide 3" style="height: 450px; object-fit: cover;">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('assets/images/products/4.webp') }}" class="d-block w-100" alt="Slide 4" style="height: 450px; object-fit: cover;">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('assets/images/products/5.jpg') }}" class="d-block w-100" alt="Slide 5" style="height: 450px; object-fit: cover;">
                </div>
            </div>
    ...
    <div class="container mt-5">
        <section class="p-5 rounded-4 text-center text-white d-flex align-items-center justify-content-center shadow-lg promotional-banner"
            ...
            <div class="banner-content p-4" style="background: rgba(0,0,0,0.3); border-radius: 20px; backdrop-filter: blur(5px);">
                ...
                <a href="{{ url('/shop') }}" class="btn btn-light btn-lg px-5 py-3 text-danger fw-bold rounded-pill shadow-sm">
                    Shop Collection
                </a>
            </div>
        </section>
        ...
        <div class="row g-4 mx-0">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100 shadow-sm border-0 product-card">
                    <img src="{{ asset('assets/images/bag.avif') }}" class="card-img-top" alt="Product" style="height: 250px; object-fit: cover;">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100 shadow-sm border-0 product-card">
                    <img src="{{ asset('assets/images/men.avif') }}" class="card-img-top" alt="Product" style="height: 250px; object-fit: cover;">
                    <div class="card-body text-center">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100 shadow-sm border-0 product-card">
                    <img src="{{ asset('assets/images/men_tshirt.avif') }}" class="card-img-top" alt="Product" style="height: 250px; object-fit: cover;">
                    <div class="card-body text-center">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100 shadow-sm border-0 product-card">
                    <img src="{{ asset('assets/images/watch.avif') }}" class="card-img-top" alt="Product" style="height: 250px; object-fit: cover;">
                    <div class="card-body text-center">
            ...
            <div class="row g-3 mx-0">
                ...
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm p-2 position-relative h-100 deal-hover-card">
                        <span class="badge bg-warning text-dark position-absolute top-0 start-0 m-2 shadow-sm">-37% OFF</span>
                        <img src="{{ asset('assets/images/watch2.avif') }}" class="card-img-top rounded" alt="Cooker" style="height: 180px; object-fit: cover;">
                        <div class="card-body px-1 py-2">
                            <h6 class="text-truncate small fw-bold mb-1">Miyako 2000W Infrared Cooker</h6>
                            <div class="price text-danger fw-bold mb-0">৳ 4,080 <del class="text-muted small">৳ 6,500</del></div>
                ...
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm p-2 position-relative h-100 deal-hover-card">
                        <span class="badge bg-warning text-dark position-absolute top-0 start-0 m-2 shadow-sm">-24% OFF</span>
                        <img src="{{ asset('assets/images/men.avif') }}" class="card-img-top rounded" alt="Watch" style="height: 180px; object-fit: cover;">
                        <div class="card-body px-1 py-2">
                            <h6 class="text-truncate small fw-bold mb-1">Fastrack Quartz Analog Watch</h6>
                            <div class="price text-danger fw-bold mb-0">৳ 3,420 <del class="text-muted small">৳ 4,500</del></div>
                            <div class="progress mt-2" style="height: 6px;">
                ...
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm p-2 position-relative h-100 deal-hover-card">
                        <span class="badge bg-warning text-dark position-absolute top-0 start-0 m-2 shadow-sm">-12% OFF</span>
                        <img src="{{ asset('assets/images/watch.avif') }}" class="card-img-top rounded" alt="Air Fryer" style="height: 180px; object-fit: cover;">
                        <div class="card-body px-1 py-2">
                            <h6 class="text-truncate small fw-bold mb-1">Miyako Air Fryer Rapid Tech</h6>
                            <div class="price text-danger fw-bold mb-0">৳ 4,200 <del class="text-muted small">৳ 4,750</del></div>
                            <div class="progress mt-2" style="height: 6px;">
                ...
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm p-2 position-relative h-100 deal-hover-card">
                        <span class="badge bg-warning text-dark position-absolute top-0 start-0 m-2 shadow-sm">-53% OFF</span>
                        <img src="{{ asset('assets/images/bag.avif') }}" class="card-img-top rounded" alt="Bag" style="height: 180px; object-fit: cover;">
                        <div class="card-body px-1 py-2">
                            <h6 class="text-truncate small fw-bold mb-1">Minimalist Laptop Backpack</h6>
                            <div class="price text-danger fw-bold mb-0">৳ 699 <del class="text-muted small">৳ 1,500</del></div>
                            <div class="progress mt-2" style="height: 6px;">
        ...
        <div class="row text-center g-4 mx-0">
            <div class="col-md-4">
                <div class="p-3 feature-box">
                    ...
                    <p class="text-muted small px-lg-4">Carefully selected fabrics for ultimate comfort and long-lasting style.</p>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="p-3 feature-box">
                    ...
                    <p class="text-muted small px-lg-4">Enjoy exclusive discounts on the latest trending fashion items.</p>
                </div>
            </div>
        </div>
    </div>
